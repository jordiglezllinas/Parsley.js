define('parsley/abstract', [
  ...
  ParsleyAbstract.prototype = {
    ...
    // Callback is called with this being the parsley instance,
    // or Parsley if global.
    ...
    // Extra arguments are passed to callbacks.
    ...
    trigger: function (name, target) {
      ...
      if (queue) {
        for(var i = queue.length; i--; ) {
          result = queue[i].apply(target, [].slice.call(arguments, 1));
